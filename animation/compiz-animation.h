...
typedef struct _AnimEffectProperties
{
    ...
    void (*setIconSizeFunc) (CompWindow *, XRectangle *);
...
typedef struct _AnimEngineInfo
{
    char *name; // name of this engine

    // Some flags go here

    void (*prePreparePaintScreenFunc) (CompScreen *s, int ms);
    void (*postPreparePaintScreenFunc) (CompScreen *s, int ms);

    void (*prePaintOutputFunc) (CompScreen *s, CompOutput *output);
    void (*postPaintOutputFunc) (CompScreen *s, CompOutput *output);

    void (*prePaintWindowFunc) (CompScreen *s, CompOutput *output);
    void (*postPaintWindowFunc) (CompScreen *s, CompOutput *output);

    void (*preHandleEventFunc) (CompDisplay *d, XEvent *event);
    void (*postHandleEventFunc) (CompDisplay *d, XEvent *event);

    void (*moveNotifyFunc) (CompWindow *w, int dy, int dx, Bool immediate);
    void (*resizeNofiyFunc) (CompWindow *w, int dy, int dx);
} AnimEngineInfo;

typedef const AnimEngineInfo * AnimEngine;
