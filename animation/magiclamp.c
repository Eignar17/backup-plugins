...
void
fxMagicLampCleanup (CompWindow *w)
{
    ANIM_WINDOW (w);
...
void
fxMagicLampSetIconSize (CompWindow *w,
			XRectangle *icon)
{
    icon->width =
	MAX (4, animGetI (w, ANIM_SCREEN_OPTION_MAGIC_LAMP_OPEN_START_WIDTH));
}

void fxVacuumSetIconSize (CompWindow *w,
			  XRectangle *icon)
{
    icon->width =
	MAX (4, animGetI (w, ANIM_SCREEN_OPTION_VACUUM_OPEN_START_WIDTH));
}
