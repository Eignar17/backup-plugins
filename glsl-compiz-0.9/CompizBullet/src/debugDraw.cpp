...
void
BulletDebugDrawer::drawSphere (	const btVector3& p,
								btScalar radius,
								const btVector3& color)
{
...
void
BulletDebugDrawer::drawBox (const btVector3& boxMin,
							...
							btScalar alpha)
{
	...
	BoxDrawer box(center.getX(), center.getY(), center.getZ(), halfExtent.getX(), halfExtent.getY(), halfExtent.getZ());
...
void
BulletDebugDrawer::drawTriangle(const btVector3& a,
								const btVector3& b,
								const btVector3& c,
								const btVector3& color,
								btScalar alpha)
...
void
BulletDebugDrawer::draw3dText(	const btVector3& location,
